...
- "intent": one of "search_emails", "summarize_emails", "important_emails", "action_items", "daily_report", "meeting_prep", "todays_meetings", "upcoming_meetings", "search_teams", "search_whatsapp", "summarize_whatsapp", "general_query", "unknown"
...
- "meeting_prep" = user wants preparation for a specific meeting
 ...
 * @param {string} calendarContext - Today's meetings
 * @returns {Promise<string>}
 */
